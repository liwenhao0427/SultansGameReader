...
export default function CardNode({ data, selected }) {
  ...
  return <BaseNode id={`card:${rawData?.id ?? data.label}`} label={label} color={COLOR} selected={selected} image={image} rare={rawData?.rare} variant="iconTitle" onExpand={data.onExpand} onRemove={data.onRemove} />
}
